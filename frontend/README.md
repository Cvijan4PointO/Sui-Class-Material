...
A learning-oriented React DApp that interacts with the
`hero_nft_marketplace::hero` smart contract. This application provides a
complete NFT marketplace experience where users can create, transfer, list, and
buy Hero NFTs. The code intentionally leaves utility function implementations as
TODOs to be completed while following along.
...
- **Smart Contract Integration**: Connects to `hero_nft_marketplace::hero` Move
  module
- **Features**:
...
const { networkConfig } = createNetworkConfig({
  devnet: {
    ...
    variables: {
      packageId: "0x[PACKAGE_ID]", // 👈 Replace this (for students that use this code the package id and network is populated)
    },
  },
  testnet: {
...
export const createHero = (
  ...
  // TODO: Add moveCall for hero_nft_marketplace::hero::create_hero
...
export const transferHero = (packageId: string, heroId: string, to: string) => {
  ...
  // TODO: Add moveCall for hero_nft_marketplace::hero::transfer_hero
...
export const listHero = (
  ...
  // TODO: Add moveCall for hero_nft_marketplace::hero::list_hero
...
export const buyHero = (
  ...
  // TODO: Add moveCall for hero_nft_marketplace::hero::buy_hero
...
The DApp interacts with these `hero_nft_marketplace::hero` functions:
